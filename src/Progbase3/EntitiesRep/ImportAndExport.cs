...
namespace EntitiesRep
{
    public static class ImportAndExport
    {
        public static void Export(long id, string path, OrderRepository orderRep, ProductRepository productRep)
        {
        ...
        public static void Import(long id, string fullName, OrderRepository orderRep, out bool error)
        {
            try
            {
