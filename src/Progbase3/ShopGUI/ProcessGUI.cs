...
namespace ShopGUI
{
    public class ProcessGUI
    {
        ...
        public void LogIn()
        {
            ...
            string db_path = @"D:\inf\progbase3\data\mydb.db";
            ...
            ProductRepository products = new ProductRepository(connection);
            UserRepository users = new UserRepository(connection);
            OrderRepository orders = new OrderRepository(connection);
        ...
        public void OnSignUpClicked()
        {
            ...
            if (usernameInput.Text.ToString() != "" || fullnameInput.Text.ToString() != "")
            {
                if (conpasswordInput.Text == passwordInput.Text)
                {
                    ...
                    {
                        MessageBox.Query("SignUp", "This name is already used. Choose another", "OK");
                    }
                }
                else
                {
            ...
            {
                MessageBox.Query("SignUp", "You haven`t entered anything, please try again!", "OK");
            }
        }
        ...
        public void CheckLogin()
        {
            ...
            {
                MessageBox.Query("Log in", "Error. Check your password and name.", "OK");
            }
        }
        ...
        {
            page = 1;
            productsList = ProductRep.GetAllCargos();
            Application.Init();
            Toplevel top = Application.Top;
            MenuBar menu = new MenuBar(new MenuBarItem[]
            {
        ...
        private void DeleteProduct()
        {
            ...
            {
                ProductRep.DeleteById(ProductRep.GetAllCargos()[products.SelectedItem + (page - 1) * 10].id);
                products.SetSource(ProductRep.GetAllCargos());
        ...
        {
            EditProduct dialog = new EditProduct(ProductRep, ProductRep.GetAllCargos()[products.SelectedItem + (page - 1) * 10].id);
            dialog.SetRepository(UserRep, OrderRep, ProductRep);
            Application.Run(dialog);
            OnListproductsClicked();
        }
        ...
        {
            MessageBox.Query("Info", "This is simple model of online shop", "OK");
        }
        ...
        {
            MessageBox.Query("Info", "This option is under development", "OK");
        }
        public void SetRepository(UserRepository UserRep, OrderRepository OrderRep, ProductRepository ProductRep)
        {
